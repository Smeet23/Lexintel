  ...
  if (citations.length === 0) {
    return (
      <div className={cn("flex flex-col items-center justify-center py-12 text-center", className)}>
        ...
        <p className="text-[12px] text-muted-foreground mt-1">Ask a question to see supporting authorities</p>
      </div>
    )
  }
  ...
  return (
    <div className={cn("space-y-3", className)}>
      <div className="flex items-center justify-between">
        <h4 className="text-[12px] font-medium text-muted-foreground uppercase tracking-[0.06em]">
        ...
        {citations.map((citation, idx) => (
          ...
          >
            <div className="flex items-start gap-2.5">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-surface text-muted-foreground group-hover:bg-surface-hover transition-colors">
              ...
              <div className="flex-1 min-w-0">
                ...
                {citation.excerpt && (
                  <p className="text-[11px] text-muted-foreground/70 mt-1.5 line-clamp-2 italic leading-relaxed">
